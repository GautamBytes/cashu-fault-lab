...
export const DOCUMENTATION_DESTINATIONS: readonly DocumentationDestination[] = [
  ...
  },
  {
    ...
    title: 'Release notes',
    description: 'What changed in the v0.1.2 maintainer preview and how to try it.',
    group: 'Release',
    order: 80,
  },
  {
    ...
    description: 'Completed v0.1.2 requirements and remaining external-validation blockers.',
    group: 'Release',
    order: 90,
  },
];

  ...
  it.each(supportedAdapterLanguages)(
    ...
    async (language) => {
      ...
      try {
        ...
        expect(text).toContain('cashu-fault-lab@0.1.4 adapter preflight');
        expect(text).toContain('cashu-fault-lab@0.1.4 adapter preview');
        const workflow = await readFile(join(output, '.github/workflows/ci.yml'), 'utf8');
        expect(workflow).toContain('permissions:\n  contents: read');
        expect(workflow).toContain('cashu-fault-lab@0.1.4 adapter preflight');
